...
thread 2 to acquire a lock on account B, now thread 1 waits for Account A
and Thread 2 waits for account B, since neither thread releases the lock,
both keep waiting and thus creating a DEADLOCK ❌🔏

ℹ️ DEADLOCK Explanation : deadlock occurs when each thread is holding
a resource and waiting for the other to release it.
 */